...
$locale['425'] = "<h2> Advertencia! </h2> <br />
Está a punto de eliminar al usuario <strong>%s </strong>! <br />
La siguiente <u> contenidos publicados por este usuario </u> en este sitio se borrará si continúa: <br />
- Artículos <br />
- Noticias <br />
- Temas del foro. Tenga en cuenta que los mensajes de otros usuarios en estos temas, también se eliminan, junto con los votos electorales y attachemets existentes en estos temas. <br />
- Mensajes <br />
- Foro attachements <br />
- Comentarios <br />
- Los mensajes privados enviados o recibidos por este usuario <br />
- Tema Opiniones <br />
- Calificaciones otorgadas <br />
A menos que se trata de un emisor de spam por ejemplo. se recomienda para la Prohibición, suspender, cancelar o Anomymize este usuario. <br />
<br />
