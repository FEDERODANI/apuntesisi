...
echo "\n\n<!--Facebook Connect Version 2.2.1 || PHPFusionMods.com-->\n\n";
...
LIMIT 1");
        ...
        } else
        {
            ...
            echo "<td class='tbl2' width='1%' valign='middle'>";
            echo "<img src='https://graph.facebook.com/" . $user . "/picture?type=normal' />";
            ...
            if ($e2)
            {
                ...
                echo "<input type='text' name='user_name' class='textbox' style='width:150px' value='" . $user1 . "' /><br />";
                ...
                echo "<input type='text' name='user_email' class='textbox' style='width:150px' value='" . $email1 . "' /><br /><br />";
                echo "<input type='submit' name='register' value='{$locale['register']}' class='button' style='margin-left:15px;' />";
                echo "</form>\n";
                echo "</td>\n";
            ...
            echo "</td></tr>";
            echo "<tr><td class='forum-caption' align='right' colspan='2'><a href='http://www.phpfusionmods.com/' title='Facebook Infusion Copyright 2012 NetriX
PHPFusionMods.com' target='_blank'>&copy;</a></td></tr>";
            echo "</table>";
        }
    }
    ...
    if (iMEMBER)
    {
        ...
        } else
        {
            ...
            {
                dbquery("UPDATE " . DB_USERS . " SET user_oauth_uid='" . $id . "' WHERE user_id='" . $userdata['user_id'] . "'");
            }
            echo $locale['success'];
        }
    }
